...
| Metric | Value |
|---|---|
| **Total published entries** | 4,152 (as of 2026-08-30; 4,278 active in hub.db, of which 126 with broken URLs are held out of published outputs; UChicago Consortium 31 -> 320, WestEd 14 -> 912, EdTrust 31 -> 362 and NWEA Research 70 -> 309 backfilled on 2026-08-30, with 364 WestEd and 26 EdTrust out-of-scope-type items recorded as excluded `type_filtered` rows) |
