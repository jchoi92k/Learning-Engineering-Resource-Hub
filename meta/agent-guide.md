...
| Metric | Value |
|---|---|
| **Total published entries** | 3,582 (as of 2026-08-30; 3,708 active in hub.db, of which 126 with broken URLs are held out of published outputs; UChicago Consortium 31 -> 320 and WestEd 14 -> 912 backfilled on 2026-08-30, with 364 WestEd practitioner-resource items recorded as excluded `type_filtered` rows) |
