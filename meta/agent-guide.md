...
| Metric | Value |
|---|---|
| **Total published entries** | 3,913 (as of 2026-08-30; 4,039 active in hub.db, of which 126 with broken URLs are held out of published outputs; UChicago Consortium 31 -> 320, WestEd 14 -> 912 and EdTrust 31 -> 362 backfilled on 2026-08-30, with 364 WestEd and 26 EdTrust out-of-scope-type items recorded as excluded `type_filtered` rows) |
