...
Source list is read from data/source-targets.json — no hardcoded list to drift.
Sources without both sample_url and discovery_check fields are skipped.

Usage: python scripts/source_check.py
"""
...
TARGETS_FILE = ROOT / "data" / "source-targets.json"
